...
- YouTube/video ve geçici klasörler kapsam dışı.
- Son doğrulama kapsamı belge yolları ve diff; runtime testi / yayın yapılmadı.
- Git: main, origin mevcut; kesin commit/push sonucunu güncel Git geçmişinden kontrol et.

Yeni sohbet: `101-Yaz-Boz kökündeki HANDOFF.md, WORKFLOW.md ve CONVERSATION_CONTEXT.md dosyalarını okuyup repo-map.md üzerinden yalnız görevimle ilgili modüle git; görevim: …`
